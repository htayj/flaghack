...
| **Partial**   | 8, 27: verify/docs workflow and generated-file rules                                                                          | Root verify aliases, `AGENTS.md`, `README.org`, package ownership READMEs, and `docs/testing-gates.md` document current gates, lifecycle/stream architecture, and generated-file guardrails.                                                                         | No CI pipeline is claimed, and the one-command cleanup/build/codegen workflow from the original recommendation remains broader than current gates.                                                                                                                                                                                                                                     | `pnpm generated:guard`; `pnpm format:check`; documented smoke gates.                               |
...
### 27. README/dev docs were stale and lacked generated-file rules

- **Historical evidence:** README said build “will probably fail”; package READMEs were templates; no `AGENTS.md`/`CONTRIBUTING.md` was present at the audited commit.
- **Current status:** `AGENTS.md`, `README.org`, package ownership READMEs, and `docs/testing-gates.md` now document generated/disposable files, bot-port validation, lifecycle/stream ownership, and handoff gates. A CI-backed canonical clean/build/codegen workflow remains open.
