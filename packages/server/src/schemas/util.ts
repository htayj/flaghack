...
/**
 * Collects a set of attributes into 2 representations
 * [
 *  a schema representing the combination of all of them,
		a schema representing any one of them
 * ]
 */
