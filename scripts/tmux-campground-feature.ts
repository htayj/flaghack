...
const noTrackerOrHiddenDestinations = String
  .raw`Objective:|[Qq]uest(?:-| )tracker|Campground Directory|Water Station|The Effigy|The Temple`
...
process.env.FLAGHACK_TMUX_STEPS = JSON.stringify([
  {
    ...
    reject: noTrackerOrHiddenDestinations
  },
  {
    expect: String
